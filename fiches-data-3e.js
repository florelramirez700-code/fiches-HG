...
g3_1: {
  ...
  resume: [
    {titre:"1. Localisation du Togo", texte:"Le Togo est un pays d'Afrique de l'Ouest, situé dans la zone intertropicale, présentant la forme caractéristique d'un couloir étroit orienté nord-sud sur près de 600 km de longueur, avec une façade maritime relativement modeste sur le golfe de Guinée au sud, entre 50 et 150 km de largeur seulement selon les endroits."},
    {titre:"2. Limites du Togo", texte:"Le Togo est limité au nord par le Burkina Faso, à l'est par le Bénin, à l'ouest par le Ghana, et au sud par l'océan Atlantique, précisément par le golfe de Guinée. Ces frontières, comme celles de la plupart des pays africains, résultent directement du découpage colonial opéré par les puissances européennes à la fin du XIXe et au début du XXe siècle, sans toujours tenir compte des réalités ethniques et culturelles préexistantes."},
    {titre:"3. Données générales sur le pays", texte:"Le Togo s'étend sur environ 56 600 km², une superficie relativement modeste comparée à ses voisins immédiats. Selon le 5e Recensement général de la population et de l'habitat (RGPH-5, INSEED, novembre 2022), sa population résidente s'élève à 8 095 498 habitants, dont 3 944 510 hommes et 4 150 988 femmes, soit une légère majorité féminine. Sa capitale politique et économique est Lomé, et sa monnaie officielle est le franc CFA, partagée avec les sept autres pays membres de l'Union économique et monétaire ouest-africaine (UEMOA)."},
    {titre:"4. Repères cartographiques à retenir", texte:"Sur le croquis du Togo réalisé à partir d'un quadrillage, il convient de savoir situer et nommer précisément : les quatre entités limitrophes du pays (Burkina Faso au nord, Ghana à l'ouest, Bénin à l'est, océan Atlantique au sud), la capitale Lomé, ainsi que la forme allongée et étroite caractéristique du territoire togolais, résultat direct du découpage colonial de la fin du XIXe siècle."}
  ],
...
g3_2: {
  ...
  resume: [
    {titre:"1. Le relief du Togo", texte:"Le relief togolais est globalement peu élevé et relativement diversifié selon les régions. Il comprend une plaine côtière assez étroite au sud, des plateaux modérés au centre du pays, et surtout la chaîne montagneuse dite de l'Atakora (également appelée chaîne des monts Togo ou chaîne kabyè selon les tronçons considérés), qui traverse diagonalement le pays du sud-ouest vers le nord-est. Le point culminant national est le mont Agou, situé dans la région des Plateaux, avec une altitude d'environ 986 mètres, suivi par le pic d'Alédjo dans la région Centrale."},
    {titre:"2. L'hydrographie du Togo", texte:"Le réseau hydrographique togolais s'organise principalement autour de deux grands bassins versants distincts : le bassin du Mono à l'est du pays, structuré autour du fleuve Mono, qui prend sa source au Bénin voisin et marque en partie la frontière naturelle entre les deux pays ; et le bassin de la Volta à l'ouest et au nord, avec le fleuve Oti, principal affluent togolais du fleuve Volta ghanéen. Le lac Togo, situé à proximité immédiate du littoral, constitue par ailleurs un plan d'eau économiquement important, à la fois pour la pêche locale et pour le développement du tourisme balnéaire régional."},
    {titre:"3. Repères cartographiques à retenir", texte:"Sur le croquis de l'hydrographie togolaise à réaliser, il convient de savoir situer précisément : le fleuve Mono à l'est du territoire, le fleuve Oti au nord du pays, le lac Togo à proximité du littoral méridional, ainsi que la chaîne montagneuse traversant diagonalement le pays du sud-ouest vers le nord-est, incluant le point culminant national, le mont Agou."}
  ],
...
g3_3: {
  ...
  resume: [
    {titre:"1. Les types de climat au Togo", texte:"Le Togo connaît une progressive transition climatique très nette du sud vers le nord du pays : un climat de type subéquatorial ou guinéen prévaut au sud, caractérisé par deux saisons des pluies distinctes et deux saisons sèches successives dans l'année ; tandis qu'un climat tropical de type soudanien domine au nord, avec cette fois une seule et unique saison des pluies, suivie d'une longue saison sèche pouvant s'étendre sur près de sept mois consécutifs, de novembre à mai."},
    {titre:"2. Les éléments constitutifs du climat", texte:"Les températures moyennes restent globalement élevées et relativement stables tout au long de l'année sur l'ensemble du territoire togolais, oscillant généralement entre 24°C et 30°C selon les saisons et les régions. Les précipitations annuelles sont nettement plus abondantes dans la région des Plateaux (climat le plus humide du pays, dépassant parfois 1 500 mm par an), et diminuent progressivement vers le nord ainsi que, paradoxalement, vers le littoral immédiat, qui connaît un microclimat localement plus sec malgré sa position côtière, phénomène expliqué par les courants marins froids longeant la côte."},
    {titre:"3. Conséquences pour les activités humaines", texte:"Cette diversité climatique nord-sud explique directement la grande variété des cultures pratiquées selon les régions du pays : des cultures pluviales à cycle court et résistantes à la sécheresse dans le nord soudanien (mil, sorgho), des cultures de rente exigeantes en humidité (café, cacao) dans les zones plus arrosées du centre-sud, et enfin des cultures maraîchères et vivrières particulièrement variées dans le sud du pays, bénéficiant d'un calendrier agricole étalé sur deux saisons de pluies distinctes."}
  ],
...
g3_4: {
  ...
  resume: [
    {titre:"1. Les types de sols du Togo", texte:"On distingue au Togo trois grandes catégories principales de sols selon les régions : les sols ferrugineux, dominants dans les régions septentrionales du pays (Savanes, Kara), de fertilité moyenne et sensibles à l'érosion en cas de déboisement ; les sols ferralitiques, présents au sud et au centre du territoire, davantage lessivés par les fortes précipitations mais généralement plus fertiles, notamment dans la région des Plateaux ; et enfin les sols hydromorphes, localisés dans les zones basses et régulièrement inondées, particulièrement propices à la riziculture."},
    {titre:"2. La végétation du Togo", texte:"La végétation togolaise varie très nettement selon un gradient nord-sud : savane arborée et arbustive clairsemée dans les régions des Savanes et de la Kara au nord, forêts claires et zones de transition savane-forêt dans la région Centrale, et enfin reliques de forêt dense semi-décidue, aujourd'hui fortement réduites par l'action humaine, dans la région des Plateaux ainsi que le long des principaux cours d'eau, sous forme de forêts-galeries protégées."},
    {titre:"3. Repères cartographiques à retenir", texte:"Sur la carte des sols et de la végétation togolaise, il convient de savoir situer les grandes zones de sols dominants selon les régions administratives du pays, ainsi que la répartition générale nord-sud de la végétation naturelle, allant de la savane de type sahélo-soudanien au nord jusqu'aux reliques de forêt dense semi-décidue au sud, en passant par les zones de transition intermédiaires du centre du pays."}
  ],
...
g3_5: {
  ...
  resume: [
    {titre:"1. Les mouvements de population togolaise", texte:"Le Togo connaît d'importants mouvements de population à l'intérieur même de son territoire national, au premier rang desquels figure un exode rural particulièrement marqué depuis les campagnes du nord et du centre du pays vers les grandes villes du sud, en particulier vers la capitale Lomé, ainsi que des migrations saisonnières plus temporaires liées directement au calendrier des travaux agricoles selon les régions et les périodes de l'année."},
    {titre:"2. La répartition géographique de la population", texte:"La population togolaise est très inégalement répartie sur l'ensemble du territoire national : elle se trouve fortement concentrée dans la région Maritime, tout particulièrement autour de la capitale Lomé et de son agglomération, ainsi que dans certaines zones traditionnellement très densément peuplées de la région de la Kara (notamment le pays kabyè), tandis que de vastes espaces ruraux du nord et du centre du pays restent, à l'inverse, relativement faiblement peuplés."},
    {titre:"3. Les facteurs explicatifs de cette répartition", texte:"Cette répartition géographique très inégale de la population togolaise s'explique par la combinaison de plusieurs facteurs déterminants : la fertilité variable des sols selon les régions, la présence beaucoup plus importante d'infrastructures économiques et d'opportunités d'emploi autour de la capitale et des grandes villes, ainsi que par des facteurs historiques et coloniaux qui ont favorisé le développement économique préférentiel de certaines zones côtières au détriment de l'intérieur du pays."}
  ],
...
g3_6: {
  ...
  resume: [
    {titre:"1. La composition ethnique de la population togolaise", texte:"Le Togo compte au total une quarantaine de groupes ethniques distincts répartis sur l'ensemble de son territoire national, parmi lesquels les plus importants démographiquement sont les Éwé, les Mina et les Aja dans les régions du sud du pays, ainsi que les Kabyè et les Tem (également appelés Kotokoli) dans les régions du centre et du nord, aux côtés de nombreux autres groupes ethniques moins nombreux mais tout aussi présents dans la diversité culturelle nationale."},
    {titre:"2. La structure démographique par âge de la population", texte:"La population togolaise se caractérise par une structure démographique particulièrement jeune : l'âge médian de la population se situe actuellement autour de vingt ans seulement, résultat direct d'une natalité encore élevée, ce qui se traduit concrètement par une pyramide des âges présentant une base très large typique des pays en développement démographique, avec une proportion très importante d'enfants et de jeunes de moins de vingt-cinq ans dans la population totale du pays."},
    {titre:"3. Les enjeux liés à cette structure démographique", texte:"Cette jeunesse marquée de la population togolaise représente à la fois un potentiel considérable pour le développement futur du pays, en termes de main-d'œuvre disponible et de dynamisme économique et social, mais elle exige également, en contrepartie, des investissements publics soutenus et continus dans les domaines essentiels de l'éducation, de la santé et surtout de la création d'emplois suffisants pour cette génération montante, sous peine de voir cette jeunesse devenir une source potentielle de tensions sociales plutôt qu'un véritable atout national."}
  ],
...
g3_7: {
  ...
  resume: [
    {titre:"1. Les conditions naturelles de l'agriculture togolaise", texte:"L'agriculture togolaise dépend étroitement des conditions naturelles du pays, qui varient sensiblement selon les régions : le relief (plaines côtières, plateaux fertiles, zones montagneuses), l'hydrographie (fleuves Mono, Zio, Oti et leurs nombreux affluents utilisés pour l'irrigation), le climat (zones nettement plus humides au sud, favorables aux cultures de rente, contre des zones plus sèches et à saison unique au nord), ainsi que les types de sols (ferrugineux, ferralitiques, hydromorphes) et la végétation naturelle, qui déterminent ensemble les cultures possibles selon les régions du pays."},
    {titre:"2. Une agriculture dominante dans l'économie nationale", texte:"L'agriculture emploie encore aujourd'hui la majorité de la population active togolaise et demeure ainsi le principal secteur économique national, combinant harmonieusement une agriculture vivrière destinée à l'alimentation locale (maïs, sorgho, igname, manioc) et une agriculture de rente clairement tournée vers l'exportation et les recettes en devises (coton principalement, café et cacao dans une moindre mesure)."},
    {titre:"3. Les grandes cultures selon les régions du pays", texte:"Le coton, principale culture de rente togolaise, est cultivé essentiellement dans les régions septentrionales des Savanes et de la Kara ; le café et le cacao, cultures plus exigeantes en humidité, sont concentrés dans la région des Plateaux, qui bénéficie d'un climat plus favorable ; tandis que les cultures vivrières diverses sont, quant à elles, présentes de manière plus uniforme sur l'ensemble du territoire national, avec toutefois une intensité de production particulièrement marquée dans les zones les plus densément peuplées du pays."},
    {titre:"4. Importance et défis actuels de l'agriculture togolaise", texte:"L'agriculture contribue de manière significative au PIB national ainsi qu'aux recettes d'exportation togolaises, le coton demeurant historiquement le principal produit agricole exporté par le pays. Ce secteur reste néanmoins confronté à plusieurs défis structurels persistants : une mécanisation encore très faible, une forte dépendance aux aléas climatiques imprévisibles, ainsi qu'une nécessité urgente de moderniser les techniques de production et de mieux structurer les filières agricoles nationales."},
    {titre:"5. Repères cartographiques à retenir", texte:"Sur la carte agricole du Togo à réaliser, il convient de savoir situer avec précision les principales zones de production selon les régions : le coton concentré dans le nord du pays (Savanes et Kara), le café et le cacao localisés spécifiquement dans la région des Plateaux, et les cultures vivrières diverses réparties de façon plus homogène sur l'ensemble du territoire national togolais."}
  ],
  ...
  croquis: {titre: "Carte agricole du Togo", svg: "<svg viewBox=\"0 0 460 540\" xmlns=\"http://www.w3.org/2000/svg\" font-family=\"Public Sans, sans-serif\">\n<rect width=\"460\" height=\"540\" fill=\"#F3F0E6\"/>\n<g transform=\"translate(90,20)\">\n<line x1=\"0\" y1=\"0\" x2=\"0\" y2=\"480\" stroke=\"#8C9A94\" stroke-width=\"0.5\" opacity=\"0.35\"/>\n<line x1=\"40\" y1=\"0\" x2=\"40\" y2=\"480\" stroke=\"#8C9A94\" stroke-width=\"0.5\" opacity=\"0.35\"/>\n<line x1=\"80\" y1=\"0\" x2=\"80\" y2=\"480\" stroke=\"#8C9A94\" stroke-width=\"0.5\" opacity=\"0.35\"/>\n<line x1=\"120\" y1=\"0\" x2=\"120\" y2=\"480\" stroke=\"#8C9A94\" stroke-width=\"0.5\" opacity=\"0.35\"/>\n<line x1=\"160\" y1=\"0\" x2=\"160\" y2=\"480\" stroke=\"#8C9A94\" stroke-width=\"0.5\" opacity=\"0.35\"/>\n<line x1=\"200\" y1=\"0\" x2=\"200\" y2=\"480\" stroke=\"#8C9A94\" stroke-width=\"0.5\" opacity=\"0.35\"/>\n<line x1=\"240\" y1=\"0\" x2=\"240\" y2=\"480\" stroke=\"#8C9A94\" stroke-width=\"0.5\" opacity=\"0.35\"/>\n<line x1=\"280\" y1=\"0\" x2=\"280\" y2=\"480\" stroke=\"#8C9A94\" stroke-width=\"0.5\" opacity=\"0.35\"/>\n<line x1=\"0\" y1=\"0\" x2=\"300\" y2=\"0\" stroke=\"#8C9A94\" stroke-width=\"0.5\" opacity=\"0.35\"/>\n<line x1=\"0\" y1=\"40\" x2=\"300\" y2=\"40\" stroke=\"#8C9A94\" stroke-width=\"0.5\" opacity=\"0.35\"/>\n<line x1=\"0\" y1=\"80\" x2=\"300\" y2=\"80\" stroke=\"#8C9A94\" stroke-width=\"0.5\" opacity=\"0.35\"/>\n<line x1=\"0\" y1=\"120\" x2=\"300\" y2=\"120\" stroke=\"#8C9A94\" stroke-width=\"0.5\" opacity=\"0.35\"/>\n<line x1=\"0\" y1=\"160\" x2=\"300\" y2=\"160\" stroke=\"#8C9A94\" stroke-width=\"0.5\" opacity=\"0.35\"/>\n<line x1=\"0\" y1=\"200\" x2=\"300\" y2=\"200\" stroke=\"#8C9A94\" stroke-width=\"0.5\" opacity=\"0.35\"/>\n<line x1=\"0\" y1=\"240\" x2=\"300\" y2=\"240\" stroke=\"#8C9A94\" stroke-width=\"0.5\" opacity=\"0.35\"/>\n<line x1=\"0\" y1=\"280\" x2=\"300\" y2=\"280\" stroke=\"#8C9A94\" stroke-width=\"0.5\" opacity=\"0.35\"/>\n<line x1=\"0\" y1=\"320\" x2=\"300\" y2=\"320\" stroke=\"#8C9A94\" stroke-width=\"0.5\" opacity=\"0.35\"/>\n<line x1=\"0\" y1=\"360\" x2=\"300\" y2=\"360\" stroke=\"#8C9A94\" stroke-width=\"0.5\" opacity=\"0.35\"/>\n<line x1=\"0\" y1=\"400\" x2=\"300\" y2=\"400\" stroke=\"#8C9A94\" stroke-width=\"0.5\" opacity=\"0.35\"/>\n<line x1=\"0\" y1=\"440\" x2=\"300\" y2=\"440\" stroke=\"#8C9A94\" stroke-width=\"0.5\" opacity=\"0.35\"/>\n<line x1=\"0\" y1=\"480\" x2=\"300\" y2=\"480\" stroke=\"#8C9A94\" stroke-width=\"0.5\" opacity=\"0.35\"/>\n<clipPath id=\"togoClip\"><path d=\"M 210.0,450.7 L 159.5,470.0 L 145.6,438.3 L 128.9,380.9 L 123.9,336.0 L 137.7,254.6 L 122.0,221.6 L 116.0,150.4 L 116.2,84.8 L 90.0,38.2 L 94.6,10.0 L 149.5,11.9 L 141.5,59.5 L 160.7,86.2 L 182.4,117.8 L 184.8,162.2 L 197.4,180.8 L 194.6,388.4 L 210.0,450.7 Z\"/></clipPath>\n<path d=\"M 210.0,450.7 L 159.5,470.0 L 145.6,438.3 L 128.9,380.9 L 123.9,336.0 L 137.7,254.6 L 122.0,221.6 L 116.0,150.4 L 116.2,84.8 L 90.0,38.2 L 94.6,10.0 L 149.5,11.9 L 141.5,59.5 L 160.7,86.2 L 182.4,117.8 L 184.8,162.2 L 197.4,180.8 L 194.6,388.4 L 210.0,450.7 Z\" fill=\"#EDEAE0\" stroke=\"none\"/>\n<path d=\"M 210.0,450.7 L 159.5,470.0 L 145.6,438.3 L 128.9,380.9 L 123.9,336.0 L 137.7,254.6 L 122.0,221.6 L 116.0,150.4 L 116.2,84.8 L 90.0,38.2 L 94.6,10.0 L 149.5,11.9 L 141.5,59.5 L 160.7,86.2 L 182.4,117.8 L 184.8,162.2 L 197.4,180.8 L 194.6,388.4 L 210.0,450.7 Z\" fill=\"none\" stroke=\"#153F38\" stroke-width=\"2.5\"/>\n<text x=\"150\" y=\"-4\" font-size=\"10\" fill=\"#202A3C\" font-weight=\"700\" text-anchor=\"middle\">BURKINA FASO</text>\n<text x=\"-14\" y=\"250\" font-size=\"10\" fill=\"#202A3C\" text-anchor=\"middle\" font-weight=\"700\" transform=\"rotate(-90,-14,250)\">GHANA</text>\n<text x=\"318\" y=\"250\" font-size=\"10\" fill=\"#202A3C\" text-anchor=\"middle\" font-weight=\"700\" transform=\"rotate(90,318,250)\">BÉNIN</text>\n<text x=\"150\" y=\"500\" font-size=\"10\" fill=\"#1F5C52\" font-weight=\"700\" text-anchor=\"middle\">OCÉAN ATLANTIQUE</text>\n</g>\n<g transform=\"translate(90,20)\">\n<circle cx=\"105.7\" cy=\"23.4\" r=\"6\" fill=\"#A6472B\" stroke=\"#fff\" stroke-width=\"1.5\"/><text x=\"113.7\" y=\"27.4\" font-size=\"11\" fill=\"#202A3C\" font-weight=\"600\" text-anchor=\"start\">Coton</text>\n<circle cx=\"167.7\" cy=\"142.7\" r=\"6\" fill=\"#A6472B\" stroke=\"#fff\" stroke-width=\"1.5\"/><text x=\"175.7\" y=\"146.7\" font-size=\"11\" fill=\"#202A3C\" font-weight=\"600\" text-anchor=\"start\">Coton</text>\n<circle cx=\"163.9\" cy=\"325.3\" r=\"6\" fill=\"#A6472B\" stroke=\"#fff\" stroke-width=\"1.5\"/><text x=\"171.9\" y=\"329.3\" font-size=\"11\" fill=\"#202A3C\" font-weight=\"600\" text-anchor=\"start\">Café, cacao</text>\n<circle cx=\"169.6\" cy=\"451.8\" r=\"6\" fill=\"#A6472B\" stroke=\"#fff\" stroke-width=\"1.5\"/><text x=\"177.6\" y=\"455.8\" font-size=\"11\" fill=\"#202A3C\" font-weight=\"600\" text-anchor=\"start\"><tspan x=\"177.6\" dy=\"0\">Cultures</tspan><tspan x=\"177.6\" dy=\"13\">vivrières</tspan></text>\n</g></svg>", legende: "Répartition schématique des grandes cultures togolaises."},
  photo: null
},
...
g3_8: {
  ...
  resume: [
    {titre:"1. Les industries togolaises", texte:"L'industrie togolaise demeure encore relativement modeste à l'échelle régionale, mais repose principalement sur la transformation de matières premières disponibles localement : plusieurs cimenteries importantes exploitant les gisements calcaires nationaux, des industries agroalimentaires diversifiées (huileries de palme, brasseries de bière et de boissons gazeuses), et surtout l'extraction ainsi que la transformation partielle des phosphates, l'une des principales ressources minières et sources de devises du pays depuis plusieurs décennies."},
    {titre:"2. Localisation des principales activités industrielles", texte:"Les principales unités industrielles togolaises sont géographiquement concentrées autour de la capitale Lomé et de sa vaste zone portuaire (favorisant l'importation d'intrants et l'exportation des productions), ainsi que dans les zones minières spécialisées d'extraction, notamment à Hahotoé et Kpogamé, où sont exploités les gisements de phosphates qui font la réputation industrielle du pays depuis les années 1960."},
    {titre:"3. Défis et perspectives de l'industrialisation togolaise", texte:"Le Togo cherche activement, depuis plusieurs années, à diversifier son tissu industriel national encore trop dépendant de quelques secteurs traditionnels, notamment à travers le développement volontariste de la zone franche industrielle de Lomé, spécifiquement destinée à attirer les investissements étrangers directs et à favoriser, à terme, la création d'une valeur ajoutée locale plus importante plutôt que la simple exportation continue de matières premières brutes et peu transformées."}
  ],
...
g3_9: {
  ...
  resume: [
    {titre:"1. Le commerce intérieur togolais", texte:"Le commerce togolais s'appuie historiquement sur un réseau particulièrement dense et dynamique de marchés traditionnels répartis sur l'ensemble du territoire national, au premier rang desquels figure le grand marché central de Lomé, historiquement animé par les célèbres commerçantes surnommées les « Nana Benz », véritables pionnières du commerce des tissus wax qui ont fait la renommée commerciale du Togo dans toute la sous-région ouest-africaine durant plusieurs décennies."},
    {titre:"2. Le commerce extérieur du Togo", texte:"Sur le plan des échanges internationaux, le Togo exporte principalement du coton, des phosphates, du ciment ainsi que divers produits agricoles bruts, tandis qu'il importe en contrepartie des produits manufacturés variés, des hydrocarbures raffinés et de nombreux biens de consommation courante destinés à sa population et à celle des pays voisins qu'il approvisionne également en transit."},
    {titre:"3. Le rôle stratégique régional du port de Lomé", texte:"Le port autonome de Lomé, considéré comme l'un des ports en eau profonde les plus performants d'Afrique de l'Ouest, joue un rôle absolument stratégique de plateforme commerciale régionale, desservant non seulement l'ensemble du territoire togolais mais également, en transit, plusieurs pays enclavés de l'hinterland sahélien tels que le Burkina Faso, le Mali et le Niger, faisant ainsi du Togo un acteur logistique incontournable de toute la sous-région ouest-africaine."}
  ],
...
g3_10: {
  ...
  resume: [
    {titre:"1. Qu'est-ce que l'économie bleue ?", texte:"L'économie bleue désigne l'ensemble des activités économiques directement liées à la mer, aux lagunes et plus généralement aux ressources aquatiques, lorsqu'elles sont exploitées de manière durable et respectueuse de l'environnement marin : la pêche traditionnelle et industrielle, l'aquaculture en développement, le transport maritime commercial, le tourisme côtier et balnéaire, ainsi que l'exploitation raisonnée des diverses ressources marines et énergétiques offshore."},
    {titre:"2. Les activités de l'économie bleue au Togo", texte:"Au Togo, l'économie bleue s'appuie concrètement sur plusieurs piliers : la pêche maritime pratiquée le long du littoral ainsi que la pêche lagunaire autour du lac Togo, le transport maritime commercial international assuré via le port autonome de Lomé, et un tourisme balnéaire encore relativement modeste mais en développement progressif le long des plages du littoral togolais."},
    {titre:"3. Importance stratégique pour l'économie nationale togolaise", texte:"L'économie bleue représente aujourd'hui un potentiel réel et encore largement sous-exploité de croissance économique et de création d'emplois pour le Togo, porté notamment par le rôle régional majeur du port de Lomé et par les perspectives de développement de la pêche et du tourisme côtier, tout en soulevant également d'importants défis actuels de préservation durable des ressources halieutiques marines et de lutte urgente contre l'érosion accélérée du littoral togolais, particulièrement menacé par la montée des eaux liée au changement climatique."}
  ],
...
g3_11: {
  ...
  resume: [
    {titre:"1. Les transports au Togo", texte:"Le Togo dispose d'un réseau de transport national comprenant un maillage routier reliant les principales agglomérations du pays (bien que souvent en mauvais état hors des grands axes bitumés), un chemin de fer aujourd'hui très limité, largement hérité de la période coloniale, le port autonome de Lomé constituant l'infrastructure de transport la plus stratégique du pays, ainsi que l'aéroport international de Lomé-Tokoin, principale porte d'entrée aérienne du territoire national."},
    {titre:"2. Les télécommunications togolaises", texte:"Le pays a connu, comme la plupart des pays africains, un développement particulièrement rapide de la téléphonie mobile ainsi que de l'accès progressif à Internet au cours des deux dernières décennies, avec la présence de plusieurs opérateurs de télécommunications en concurrence, ce qui facilite considérablement aujourd'hui les échanges commerciaux quotidiens ainsi que l'inclusion financière des populations à travers le paiement mobile, y compris dans les zones rurales les plus reculées du pays."},
    {titre:"3. Importance stratégique dans l'économie togolaise", texte:"Ces infrastructures de transport et de télécommunications sont absolument essentielles au bon fonctionnement du commerce intérieur comme du commerce régional togolais, tirant pleinement parti de la position géographique particulièrement stratégique du Togo, véritable point d'entrée maritime privilégié pour les pays enclavés voisins du Sahel (Burkina Faso, Mali, Niger), qui dépendent largement du port de Lomé pour leurs échanges commerciaux internationaux."},
    {titre:"4. Efforts de modernisation et défis persistants", texte:"D'importants efforts financiers et techniques sont actuellement menés par les autorités togolaises pour moderniser progressivement le réseau routier national et étendre continuellement la couverture numérique du territoire, mais certaines zones rurales reculées et enclavées demeurent encore aujourd'hui difficiles d'accès en toute saison, ce qui continue malheureusement de freiner sensiblement leur développement économique et social local."}
  ],
...
g3_12: {
  ...
  resume: [
    {titre:"1. Les potentialités touristiques du Togo", texte:"Le Togo dispose d'atouts touristiques variés et complémentaires, encore largement sous-exploités à l'échelle internationale : les plages du littoral atlantique, le lac Togo propice aux activités nautiques, les chutes d'eau et paysages montagneux pittoresques de la région des Plateaux (notamment autour de Kpalimé et du mont Kloto), de nombreux sites historiques remarquables (Notsè avec sa muraille légendaire, Aného et Glidji berceaux du peuple guin/mina), ainsi qu'une richesse culturelle vivante exceptionnelle (fêtes traditionnelles, artisanat local varié)."},
    {titre:"2. La place du tourisme dans l'économie togolaise", texte:"Le tourisme demeure encore aujourd'hui un secteur économique relativement modeste au Togo comparé à d'autres pays de la sous-région, mais il connaît un développement progressif encourageant, générant des devises étrangères précieuses et créant des emplois locaux directs et indirects, notamment dans les secteurs complémentaires de l'hôtellerie, de la restauration et de l'artisanat touristique."},
    {titre:"3. Efforts de valorisation et défis actuels du secteur", texte:"Le pays investit progressivement dans la promotion active de ses différents sites touristiques ainsi que dans l'amélioration continue des infrastructures d'accueil touristique, mais fait encore face à plusieurs défis structurels persistants, notamment l'insuffisance quantitative et qualitative des équipements hôteliers dans certaines régions, ainsi que la nécessité urgente de mieux faire connaître internationalement ses atouts touristiques encore méconnus à l'échelle mondiale."},
    {titre:"4. Repères cartographiques à retenir", texte:"Sur la carte touristique du Togo à réaliser, il convient de savoir situer précisément les principaux sites d'intérêt touristique national : les plages réputées de Lomé et d'Aného sur le littoral, le lac Togo à proximité immédiate, les monts pittoresques de Kpalimé et du Kloto dans l'arrière-pays, ainsi que les sites historiques majeurs de Notsè et de Glidji, témoins vivants du riche passé précolonial du pays."}
  ],
...
h3_1: {
  ...
  resume: [
    {titre:"1. Définition et causes de l'impérialisme", texte:"L'impérialisme désigne la politique par laquelle une puissance étend délibérément sa domination politique, économique et militaire sur d'autres territoires souverains. Ses causes profondes sont multiples et se combinent généralement entre elles : des causes stratégiques (contrôle de routes maritimes et de positions géographiques avantageuses), des causes économiques (recherche intensive de matières premières et de nouveaux débouchés commerciaux pour l'industrie européenne), des causes militaires (besoin de recruter des troupes coloniales et d'établir des bases stratégiques), ainsi que des causes démographiques (recherche de nouvelles terres pour l'émigration européenne excédentaire)."},
    {titre:"2. Caractère universel de l'impérialisme dans l'Histoire", texte:"L'impérialisme s'est manifesté à toutes les grandes époques historiques et sur pratiquement tous les continents du monde : les vastes colonies égyptiennes et romaines dès l'Antiquité, puis la colonisation européenne moderne progressive de l'Afrique, de l'Asie et de l'Amérique à partir du XVe siècle, qui s'intensifie considérablement et brutalement à la toute fin du XIXe siècle, lors de la période historique communément désignée sous le nom de « partage de l'Afrique » ou conférence de Berlin (1884-1885)."},
    {titre:"3. Moyens d'action des puissances impérialistes en Afrique", texte:"Les puissances impérialistes européennes agissent généralement d'abord par des moyens relativement pacifiques et progressifs : l'envoi d'explorateurs chargés de la cartographie détaillée des territoires convoités, l'action de missionnaires religieux se consacrant à l'évangélisation des populations locales, ainsi que l'intervention de commerçants et de banques négociant divers traités commerciaux avantageux avec les chefs locaux. Ce n'est généralement que dans un second temps, face aux résistances locales, qu'elles recourent finalement aux moyens militaires directs (invasions armées et conquêtes brutales) pour imposer durablement et consolider leur domination coloniale sur le terrain."}
  ],
...
h3_2: {
  ...
  resume: [
    {titre:"1. Une résistance togolaise quasi générale à la colonisation", texte:"Face à la conquête coloniale européenne, la très grande majorité des peuples et royaumes traditionnels du territoire togolais actuel oppose une résistance déterminée, sous des formes extrêmement variées selon les régions et les circonstances : résistance armée directe, refus catégorique de toute collaboration avec l'occupant, ou encore fuite stratégique vers des zones géographiquement plus difficiles d'accès afin d'échapper temporairement à l'autorité coloniale naissante."},
    {titre:"2. Des foyers de résistance répartis dans tout le pays", texte:"Des foyers de résistance active apparaissent ainsi simultanément aussi bien dans le nord du pays (chez les Anoufo du royaume de Mango, comme chez les populations kabyè des montagnes) que dans le centre (royaume tem du Tchaoudjo autour de Sokodé) et dans le sud (royaume aja de Tado), démontrant clairement que l'opposition farouche à la colonisation européenne ne se limitait aucunement à une seule région particulière du territoire, mais concernait bien l'ensemble du pays dans sa diversité ethnique et géographique."},
    {titre:"3. Des résistances finalement vaincues militairement", texte:"Malgré leur détermination souvent héroïque et leur connaissance approfondie du terrain local, ces différentes résistances togolaises sont progressivement matées les unes après les autres par la supériorité militaire technique décisive des puissances coloniales européennes (armes à feu modernes, effectifs militaires mieux organisés et disciplinés), aboutissant finalement à la soumission complète de l'ensemble du territoire togolais actuel à l'autorité coloniale allemande, dès la fin du XIXe siècle."},
    {titre:"4. Repères cartographiques à retenir", texte:"Sur la carte des foyers de résistance togolaise à réaliser, il convient de savoir situer précisément : la ville de Mango dans l'extrême nord (résistance emblématique du peuple anoufo), la région montagneuse du pays kabyè, la ville de Sokodé au centre (résistance du royaume tem de Tchaoudjo), ainsi que la localité de Tado dans le sud du pays (résistance du peuple aja), constituant ensemble les principaux foyers historiques de résistance à la colonisation à travers tout le territoire togolais."}
  ],
  ...
  croquis: {titre: "Foyers de résistance au Togo", svg: "<svg viewBox=\"0 0 460 540\" xmlns=\"http://www.w3.org/2000/svg\" font-family=\"Public Sans, sans-serif\">\n<rect width=\"460\" height=\"540\" fill=\"#F3F0E6\"/>\n<g transform=\"translate(90,20)\">\n<line x1=\"0\" y1=\"0\" x2=\"0\" y2=\"480\" stroke=\"#8C9A94\" stroke-width=\"0.5\" opacity=\"0.35\"/>\n<line x1=\"40\" y1=\"0\" x2=\"40\" y2=\"480\" stroke=\"#8C9A94\" stroke-width=\"0.5\" opacity=\"0.35\"/>\n<line x1=\"80\" y1=\"0\" x2=\"80\" y2=\"480\" stroke=\"#8C9A94\" stroke-width=\"0.5\" opacity=\"0.35\"/>\n<line x1=\"120\" y1=\"0\" x2=\"120\" y2=\"480\" stroke=\"#8C9A94\" stroke-width=\"0.5\" opacity=\"0.35\"/>\n<line x1=\"160\" y1=\"0\" x2=\"160\" y2=\"480\" stroke=\"#8C9A94\" stroke-width=\"0.5\" opacity=\"0.35\"/>\n<line x1=\"200\" y1=\"0\" x2=\"200\" y2=\"480\" stroke=\"#8C9A94\" stroke-width=\"0.5\" opacity=\"0.35\"/>\n<line x1=\"240\" y1=\"0\" x2=\"240\" y2=\"480\" stroke=\"#8C9A94\" stroke-width=\"0.5\" opacity=\"0.35\"/>\n<line x1=\"280\" y1=\"0\" x2=\"280\" y2=\"480\" stroke=\"#8C9A94\" stroke-width=\"0.5\" opacity=\"0.35\"/>\n<line x1=\"0\" y1=\"0\" x2=\"300\" y2=\"0\" stroke=\"#8C9A94\" stroke-width=\"0.5\" opacity=\"0.35\"/>\n<line x1=\"0\" y1=\"40\" x2=\"300\" y2=\"40\" stroke=\"#8C9A94\" stroke-width=\"0.5\" opacity=\"0.35\"/>\n<line x1=\"0\" y1=\"80\" x2=\"300\" y2=\"80\" stroke=\"#8C9A94\" stroke-width=\"0.5\" opacity=\"0.35\"/>\n<line x1=\"0\" y1=\"120\" x2=\"300\" y2=\"120\" stroke=\"#8C9A94\" stroke-width=\"0.5\" opacity=\"0.35\"/>\n<line x1=\"0\" y1=\"160\" x2=\"300\" y2=\"160\" stroke=\"#8C9A94\" stroke-width=\"0.5\" opacity=\"0.35\"/>\n<line x1=\"0\" y1=\"200\" x2=\"300\" y2=\"200\" stroke=\"#8C9A94\" stroke-width=\"0.5\" opacity=\"0.35\"/>\n<line x1=\"0\" y1=\"240\" x2=\"300\" y2=\"240\" stroke=\"#8C9A94\" stroke-width=\"0.5\" opacity=\"0.35\"/>\n<line x1=\"0\" y1=\"280\" x2=\"300\" y2=\"280\" stroke=\"#8C9A94\" stroke-width=\"0.5\" opacity=\"0.35\"/>\n<line x1=\"0\" y1=\"320\" x2=\"300\" y2=\"320\" stroke=\"#8C9A94\" stroke-width=\"0.5\" opacity=\"0.35\"/>\n<line x1=\"0\" y1=\"360\" x2=\"300\" y2=\"360\" stroke=\"#8C9A94\" stroke-width=\"0.5\" opacity=\"0.35\"/>\n<line x1=\"0\" y1=\"400\" x2=\"300\" y2=\"400\" stroke=\"#8C9A94\" stroke-width=\"0.5\" opacity=\"0.35\"/>\n<line x1=\"0\" y1=\"440\" x2=\"300\" y2=\"440\" stroke=\"#8C9A94\" stroke-width=\"0.5\" opacity=\"0.35\"/>\n<line x1=\"0\" y1=\"480\" x2=\"300\" y2=\"480\" stroke=\"#8C9A94\" stroke-width=\"0.5\" opacity=\"0.35\"/>\n<clipPath id=\"togoClip\"><path d=\"M 210.0,450.7 L 159.5,470.0 L 145.6,438.3 L 128.9,380.9 L 123.9,336.0 L 137.7,254.6 L 122.0,221.6 L 116.0,150.4 L 116.2,84.8 L 90.0,38.2 L 94.6,10.0 L 149.5,11.9 L 141.5,59.5 L 160.7,86.2 L 182.4,117.8 L 184.8,162.2 L 197.4,180.8 L 194.6,388.4 L 210.0,450.7 Z\"/></clipPath>\n<path d=\"M 210.0,450.7 L 159.5,470.0 L 145.6,438.3 L 128.9,380.9 L 123.9,336.0 L 137.7,254.6 L 122.0,221.6 L 116.0,150.4 L 116.2,84.8 L 90.0,38.2 L 94.6,10.0 L 149.5,11.9 L 141.5,59.5 L 160.7,86.2 L 182.4,117.8 L 184.8,162.2 L 197.4,180.8 L 194.6,388.4 L 210.0,450.7 Z\" fill=\"#EDEAE0\" stroke=\"none\"/>\n<path d=\"M 210.0,450.7 L 159.5,470.0 L 145.6,438.3 L 128.9,380.9 L 123.9,336.0 L 137.7,254.6 L 122.0,221.6 L 116.0,150.4 L 116.2,84.8 L 90.0,38.2 L 94.6,10.0 L 149.5,11.9 L 141.5,59.5 L 160.7,86.2 L 182.4,117.8 L 184.8,162.2 L 197.4,180.8 L 194.6,388.4 L 210.0,450.7 Z\" fill=\"none\" stroke=\"#153F38\" stroke-width=\"2.5\"/>\n<text x=\"150\" y=\"-4\" font-size=\"10\" fill=\"#202A3C\" font-weight=\"700\" text-anchor=\"middle\">BURKINA FASO</text>\n<text x=\"-14\" y=\"250\" font-size=\"10\" fill=\"#202A3C\" text-anchor=\"middle\" font-weight=\"700\" transform=\"rotate(-90,-14,250)\">GHANA</text>\n<text x=\"318\" y=\"250\" font-size=\"10\" fill=\"#202A3C\" text-anchor=\"middle\" font-weight=\"700\" transform=\"rotate(90,318,250)\">BÉNIN</text>\n<text x=\"150\" y=\"500\" font-size=\"10\" fill=\"#1F5C52\" font-weight=\"700\" text-anchor=\"middle\">OCÉAN ATLANTIQUE</text>\n</g>\n<g transform=\"translate(90,20)\">\n<circle cx=\"122.6\" cy=\"69.5\" r=\"6\" fill=\"#A6472B\" stroke=\"#fff\" stroke-width=\"1.5\"/><text x=\"130.6\" y=\"73.5\" font-size=\"11\" fill=\"#202A3C\" font-weight=\"600\" text-anchor=\"start\">Mango (Anoufo)</text>\n<circle cx=\"163.9\" cy=\"194.2\" r=\"6\" fill=\"#A6472B\" stroke=\"#fff\" stroke-width=\"1.5\"/><text x=\"171.9\" y=\"198.2\" font-size=\"11\" fill=\"#202A3C\" font-weight=\"600\" text-anchor=\"start\">Tchaoudjo</text>\n<circle cx=\"167.7\" cy=\"142.7\" r=\"6\" fill=\"#A6472B\" stroke=\"#fff\" stroke-width=\"1.5\"/><text x=\"175.7\" y=\"146.7\" font-size=\"11\" fill=\"#202A3C\" font-weight=\"600\" text-anchor=\"start\">Pays kabyè</text>\n<circle cx=\"187.7\" cy=\"379.5\" r=\"6\" fill=\"#A6472B\" stroke=\"#fff\" stroke-width=\"1.5\"/><text x=\"195.7\" y=\"383.5\" font-size=\"11\" fill=\"#202A3C\" font-weight=\"600\" text-anchor=\"start\">Tado (Aja)</text>\n</g></svg>", legende: "Principaux foyers de résistance à l'impérialisme au Togo."},
  photo: null
},
...
h3_3: {
  ...
  resume: [
    {titre:"1. Aja Kpoyizoun, souverain résistant du royaume de Tado", texte:"Aja Kpoyizoun, souverain traditionnel (portant le titre d'Anyigbafio) du royaume historique de Tado situé dans le sud du Togo actuel, refuse catégoriquement de se soumettre à l'autorité coloniale française naissante à la fin du XIXe siècle. Activement pourchassé par les troupes coloniales françaises pendant plusieurs mois, il est finalement capturé puis condamné à l'exil, déporté et interné de force à N'Djolé, dans l'actuel Gabon, où il termine tragiquement sa vie loin de son royaume et de son peuple d'origine."},
    {titre:"2. Na Biéma Asabiè, souverain guerrier des Anoufo de Mango", texte:"Na Biéma Asabiè, douzième roi de la lignée dynastique fondée historiquement par Na Biéma Bonsafo à la tête du puissant royaume anoufo établi autour de Mango dans le nord du Togo actuel, s'oppose farouchement et militairement à la pénétration coloniale allemande dans cette région septentrionale à la toute fin du XIXe siècle. Il trouve finalement la mort au combat, tombant sous les tirs des troupes coloniales allemandes lors d'affrontements armés directs pour la défense de son royaume et de son indépendance politique traditionnelle."},
    {titre:"3. Le sens profond de ces deux résistances exemplaires", texte:"Ces deux exemples historiques marquants, survenus dans deux régions géographiquement et culturellement très différentes du pays togolais actuel (le sud aja d'un côté, le nord anoufo de l'autre), démontrent clairement que des souverains togolais de traditions et de cultures pourtant très différentes ont chacun, à leur manière propre et selon leurs moyens respectifs, courageusement refusé la domination étrangère imposée par la force, au prix ultime, selon les cas, soit de leur liberté personnelle par l'exil forcé, soit directement de leur propre vie sur le champ de bataille."}
  ],
...
h3_4: {
  ...
  resume: [
    {titre:"1. La logique économique de la mise sous tutelle coloniale", texte:"Une fois la phase de conquête militaire achevée avec succès, les puissances coloniales européennes organisent méthodiquement l'exploitation économique systématique de leurs nouvelles colonies africaines : celles-ci doivent désormais fournir prioritairement des matières premières agricoles et minières à la métropole européenne, tout en constituant simultanément des marchés captifs pour l'écoulement des produits manufacturés industriels européens, selon la logique bien connue du « pacte colonial » théorisé dès le XVIIe siècle."},
    {titre:"2. Les moyens concrets de cette exploitation économique", texte:"Cette exploitation économique coloniale passe concrètement par plusieurs mécanismes complémentaires et souvent brutaux : l'imposition autoritaire de cultures de rente spécifiques répondant aux besoins de la métropole (coton, cacao, café), le recours généralisé au travail forcé des populations colonisées sur les chantiers publics et dans les plantations, la construction d'infrastructures de transport (routes et voies ferrées) systématiquement orientées vers l'exportation efficace des richesses locales (reliant les zones de production aux ports d'exportation), ainsi que la levée d'impôts coloniaux souvent très lourds pesant directement sur les populations colonisées elles-mêmes."},
    {titre:"3. Des conséquences économiques durables pour les colonies", texte:"Cette exploitation économique méthodique enrichit considérablement les métropoles coloniales européennes sur le long terme, mais freine simultanément et durablement le développement économique autonome des colonies elles-mêmes, dont les structures économiques nationales sont ainsi façonnées pour répondre prioritairement aux besoins extérieurs de la métropole plutôt qu'aux besoins réels des populations locales elles-mêmes — une dépendance économique structurelle dont les effets néfastes continuent, selon de nombreux économistes et historiens, à se faire sentir concrètement bien après les indépendances africaines des années 1960."}
  ],
...
h3_5: {
  ...
  resume: [
    {titre:"1. La mise en place officielle de la colonie allemande", texte:"Le 5 juillet 1884 précisément, l'explorateur allemand Gustav Nachtigal signe officiellement un traité de protectorat colonial avec le chef traditionnel local Mlapa III, sur la plage de Baguida au sud de la côte togolaise actuelle, donnant ainsi naissance juridique au « Togoland », qui devient à cette occasion la toute première colonie officielle de l'Empire allemand nouvellement unifié sur le continent africain."},
    {titre:"2. L'organisation administrative rigoureuse du Togo allemand", texte:"Les autorités coloniales allemandes mettent progressivement en place une administration territoriale fortement centralisée, dirigée par un gouverneur général basé à Lomé, avec plusieurs subdivisions administratives régionales confiées directement à des administrateurs allemands, tout en s'appuyant néanmoins stratégiquement, dans certaines zones reculées, sur les chefferies traditionnelles locales préexistantes afin d'asseoir plus facilement leur autorité coloniale sur l'ensemble du territoire conquis."},
    {titre:"3. Le développement économique planifié sous domination allemande", texte:"Le territoire du Togoland est officiellement présenté et vanté par les autorités allemandes comme leur véritable « colonie modèle » (Musterkolonie) en Afrique, symbole de réussite coloniale : construction méthodique de routes carrossables, mise en place de voies ferrées reliant efficacement Lomé aux villes d'Aného, de Kpalimé et d'Atakpamé, développement systématique des cultures de rente exportables (coton, café, cacao), ainsi que construction de la puissante station de radiotélégraphie stratégique de Kamina, alors considérée comme l'une des plus puissantes au monde."},
    {titre:"4. Repères cartographiques à retenir", texte:"Sur la carte administrative du Togo colonial allemand à réaliser, il convient de savoir situer précisément : la ville de Lomé, à la fois capitale administrative et port principal de la colonie, la plage de Baguida où fut signé le traité fondateur de 1884, la station stratégique de Kamina, ainsi que les principales voies ferrées coloniales construites vers Aného, Kpalimé et Atakpamé, structurant durablement l'économie territoriale du Togo allemand."}
  ],
  ...
  croquis: {titre: "Le Togo sous administration allemande", svg: "<svg viewBox=\"0 0 460 540\" xmlns=\"http://www.w3.org/2000/svg\" font-family=\"Public Sans, sans-serif\">\n<rect width=\"460\" height=\"540\" fill=\"#F3F0E6\"/>\n<g transform=\"translate(90,20)\">\n<line x1=\"0\" y1=\"0\" x2=\"0\" y2=\"480\" stroke=\"#8C9A94\" stroke-width=\"0.5\" opacity=\"0.35\"/>\n<line x1=\"40\" y1=\"0\" x2=\"40\" y2=\"480\" stroke=\"#8C9A94\" stroke-width=\"0.5\" opacity=\"0.35\"/>\n<line x1=\"80\" y1=\"0\" x2=\"80\" y2=\"480\" stroke=\"#8C9A94\" stroke-width=\"0.5\" opacity=\"0.35\"/>\n<line x1=\"120\" y1=\"0\" x2=\"120\" y2=\"480\" stroke=\"#8C9A94\" stroke-width=\"0.5\" opacity=\"0.35\"/>\n<line x1=\"160\" y1=\"0\" x2=\"160\" y2=\"480\" stroke=\"#8C9A94\" stroke-width=\"0.5\" opacity=\"0.35\"/>\n<line x1=\"200\" y1=\"0\" x2=\"200\" y2=\"480\" stroke=\"#8C9A94\" stroke-width=\"0.5\" opacity=\"0.35\"/>\n<line x1=\"240\" y1=\"0\" x2=\"240\" y2=\"480\" stroke=\"#8C9A94\" stroke-width=\"0.5\" opacity=\"0.35\"/>\n<line x1=\"280\" y1=\"0\" x2=\"280\" y2=\"480\" stroke=\"#8C9A94\" stroke-width=\"0.5\" opacity=\"0.35\"/>\n<line x1=\"0\" y1=\"0\" x2=\"300\" y2=\"0\" stroke=\"#8C9A94\" stroke-width=\"0.5\" opacity=\"0.35\"/>\n<line x1=\"0\" y1=\"40\" x2=\"300\" y2=\"40\" stroke=\"#8C9A94\" stroke-width=\"0.5\" opacity=\"0.35\"/>\n<line x1=\"0\" y1=\"80\" x2=\"300\" y2=\"80\" stroke=\"#8C9A94\" stroke-width=\"0.5\" opacity=\"0.35\"/>\n<line x1=\"0\" y1=\"120\" x2=\"300\" y2=\"120\" stroke=\"#8C9A94\" stroke-width=\"0.5\" opacity=\"0.35\"/>\n<line x1=\"0\" y1=\"160\" x2=\"300\" y2=\"160\" stroke=\"#8C9A94\" stroke-width=\"0.5\" opacity=\"0.35\"/>\n<line x1=\"0\" y1=\"200\" x2=\"300\" y2=\"200\" stroke=\"#8C9A94\" stroke-width=\"0.5\" opacity=\"0.35\"/>\n<line x1=\"0\" y1=\"240\" x2=\"300\" y2=\"240\" stroke=\"#8C9A94\" stroke-width=\"0.5\" opacity=\"0.35\"/>\n<line x1=\"0\" y1=\"280\" x2=\"300\" y2=\"280\" stroke=\"#8C9A94\" stroke-width=\"0.5\" opacity=\"0.35\"/>\n<line x1=\"0\" y1=\"320\" x2=\"300\" y2=\"320\" stroke=\"#8C9A94\" stroke-width=\"0.5\" opacity=\"0.35\"/>\n<line x1=\"0\" y1=\"360\" x2=\"300\" y2=\"360\" stroke=\"#8C9A94\" stroke-width=\"0.5\" opacity=\"0.35\"/>\n<line x1=\"0\" y1=\"400\" x2=\"300\" y2=\"400\" stroke=\"#8C9A94\" stroke-width=\"0.5\" opacity=\"0.35\"/>\n<line x1=\"0\" y1=\"440\" x2=\"300\" y2=\"440\" stroke=\"#8C9A94\" stroke-width=\"0.5\" opacity=\"0.35\"/>\n<line x1=\"0\" y1=\"480\" x2=\"300\" y2=\"480\" stroke=\"#8C9A94\" stroke-width=\"0.5\" opacity=\"0.35\"/>\n<clipPath id=\"togoClip\"><path d=\"M 210.0,450.7 L 159.5,470.0 L 145.6,438.3 L 128.9,380.9 L 123.9,336.0 L 137.7,254.6 L 122.0,221.6 L 116.0,150.4 L 116.2,84.8 L 90.0,38.2 L 94.6,10.0 L 149.5,11.9 L 141.5,59.5 L 160.7,86.2 L 182.4,117.8 L 184.8,162.2 L 197.4,180.8 L 194.6,388.4 L 210.0,450.7 Z\"/></clipPath>\n<path d=\"M 210.0,450.7 L 159.5,470.0 L 145.6,438.3 L 128.9,380.9 L 123.9,336.0 L 137.7,254.6 L 122.0,221.6 L 116.0,150.4 L 116.2,84.8 L 90.0,38.2 L 94.6,10.0 L 149.5,11.9 L 141.5,59.5 L 160.7,86.2 L 182.4,117.8 L 184.8,162.2 L 197.4,180.8 L 194.6,388.4 L 210.0,450.7 Z\" fill=\"#EDEAE0\" stroke=\"none\"/>\n<path d=\"M 210.0,450.7 L 159.5,470.0 L 145.6,438.3 L 128.9,380.9 L 123.9,336.0 L 137.7,254.6 L 122.0,221.6 L 116.0,150.4 L 116.2,84.8 L 90.0,38.2 L 94.6,10.0 L 149.5,11.9 L 141.5,59.5 L 160.7,86.2 L 182.4,117.8 L 184.8,162.2 L 197.4,180.8 L 194.6,388.4 L 210.0,450.7 Z\" fill=\"none\" stroke=\"#153F38\" stroke-width=\"2.5\"/>\n<text x=\"150\" y=\"-4\" font-size=\"10\" fill=\"#202A3C\" font-weight=\"700\" text-anchor=\"middle\">BURKINA FASO</text>\n<text x=\"-14\" y=\"250\" font-size=\"10\" fill=\"#202A3C\" text-anchor=\"middle\" font-weight=\"700\" transform=\"rotate(-90,-14,250)\">GHANA</text>\n<text x=\"318\" y=\"250\" font-size=\"10\" fill=\"#202A3C\" text-anchor=\"middle\" font-weight=\"700\" transform=\"rotate(90,318,250)\">BÉNIN</text>\n<text x=\"150\" y=\"500\" font-size=\"10\" fill=\"#1F5C52\" font-weight=\"700\" text-anchor=\"middle\">OCÉAN ATLANTIQUE</text>\n</g>\n<g transform=\"translate(90,20)\">\n<circle cx=\"169.6\" cy=\"451.8\" r=\"6\" fill=\"#A6472B\" stroke=\"#fff\" stroke-width=\"1.5\"/><text x=\"177.6\" y=\"455.8\" font-size=\"11\" fill=\"#202A3C\" font-weight=\"600\" text-anchor=\"start\">Lomé (capitale)</text>\n<circle cx=\"175.2\" cy=\"450.0\" r=\"6\" fill=\"#A6472B\" stroke=\"#fff\" stroke-width=\"1.5\"/><text x=\"183.2\" y=\"454.0\" font-size=\"11\" fill=\"#202A3C\" font-weight=\"600\" text-anchor=\"start\">Baguida (traité 1884)</text>\n<circle cx=\"163.9\" cy=\"194.2\" r=\"6\" fill=\"#A6472B\" stroke=\"#fff\" stroke-width=\"1.5\"/><text x=\"171.9\" y=\"198.2\" font-size=\"11\" fill=\"#202A3C\" font-weight=\"600\" text-anchor=\"start\">Kamina (station radio)</text>\n</g></svg>", legende: "Repères de l'administration allemande au Togo."},
  photo: {fichier: "h3_5_togo_allemand.jpg", legende: "Lomé à l'époque coloniale allemande"}
},
...
h3_6: {
  ...
  resume: [
    {titre:"1. Le passage effectif sous administration coloniale française", texte:"Après la défaite militaire allemande d'août 1914 lors de la Première Guerre mondiale, le territoire du Togoland est immédiatement occupé conjointement par les forces françaises et britanniques victorieuses, puis officiellement partagé entre les deux puissances alliées entre 1919 et 1922 : la partie orientale du territoire, correspondant approximativement au Togo actuel, devient alors un territoire officiellement placé sous mandat international de la Société des Nations (SDN), confié spécifiquement à l'administration française."},
    {titre:"2. L'administration coloniale française et ses méthodes", texte:"La France administre désormais le territoire togolais à travers un système administratif structuré de gouverneurs coloniaux et de cercles administratifs régionaux, s'appuyant largement sur le recours systématique au travail forcé des populations locales, ainsi que sur le régime juridique spécifique et profondément discriminatoire de l'indigénat envers l'ensemble des populations colonisées, tout en poursuivant activement le développement des cultures d'exportation déjà initiées par les Allemands (café, cacao notamment)."},
    {titre:"3. De la tutelle de la SDN à celle de l'ONU après 1945", texte:"Après la fin de la Seconde Guerre mondiale en 1945, le régime international de mandat de la défunte Société des Nations est officiellement remplacé par un nouveau système de tutelle placé sous l'égide de l'Organisation des Nations unies (ONU) à partir de 1946, système qui prévoit désormais explicitement un accompagnement progressif du territoire togolais vers l'autonomie politique complète, ouvrant ainsi la voie concrète aux revendications grandissantes d'indépendance nationale qui se multiplient dès cette époque."}
  ],
...
h3_7: {
  ...
  resume: [
    {titre:"1. Les causes politiques des luttes de libération", texte:"L'essor progressif des idées universelles de démocratie et d'autodétermination des peuples, largement diffusées notamment par la Charte de l'Atlantique signée en 1941 puis par la création officielle de l'ONU en 1945, encourage de façon décisive l'ensemble des peuples colonisés à travers le monde à revendiquer désormais fermement leur droit fondamental à disposer librement d'eux-mêmes et à choisir leur propre destin politique."},
    {titre:"2. Les causes économiques et sociales profondes", texte:"L'exploitation économique coloniale prolongée (travail forcé, impôts coloniaux lourds, cultures imposées de force aux paysans) nourrit progressivement, au fil des décennies, un profond ressentiment populaire parmi l'ensemble des populations colonisées, tandis que l'émergence progressive d'une véritable élite africaine, formée directement dans les écoles coloniales elles-mêmes, lui donne enfin les moyens intellectuels concrets nécessaires pour structurer efficacement ses revendications politiques légitimes face au pouvoir colonial."},
    {titre:"3. Le rôle déterminant de la Seconde Guerre mondiale", texte:"La participation active et massive de nombreux soldats africains (les célèbres tirailleurs) à l'effort de guerre mondial aux côtés des puissances coloniales elles-mêmes renforce considérablement, au retour de ces anciens combattants, leur conscience politique naissante ainsi que leur sentiment légitime d'avoir désormais droit, en juste retour de leur sacrifice consenti, à davantage de liberté politique et de reconnaissance sociale de la part des mêmes puissances coloniales qu'ils avaient contribué à défendre militairement."}
  ],
...
h3_8: {
  ...
  resume: [
    {titre:"1. Les principaux acteurs de la lutte pour l'indépendance au Togo", texte:"Au Togo, la lutte politique organisée pour l'indépendance nationale est principalement portée par le Comité de l'Unité Togolaise (CUT), parti politique fondé dès 1941 et dirigé notamment par la figure historique de Sylvanus Olympio, qui revendique alors avec force la réunification politique complète des deux territoires togolais existants (le Togo sous administration française et le Togoland sous administration britannique) ainsi que l'indépendance nationale pleine et entière du pays réunifié."},
    {titre:"2. Les événements politiques de 1950 à 1958", texte:"Cette période cruciale est marquée par la domination croissante de la vie politique nationale togolaise par les partis politiques progressistes, les élections législatives organisées en 1955, la montée en puissance continue des différents partis nationalistes togolais, la proclamation officielle de la République autonome du Togo en 1956, puis l'organisation des élections législatives décisives de 1958, qui ouvrent définitivement la voie politique à la proclamation prochaine de l'indépendance nationale complète en 1960."},
    {titre:"3. Les étapes finales vers l'indépendance nationale", texte:"Placé sous le régime international de tutelle de l'ONU depuis 1946, le Togo obtient ainsi progressivement une autonomie politique interne toujours plus large au cours des années 1950, avant de proclamer solennellement son indépendance nationale complète le 27 avril 1960, avec Sylvanus Olympio comme tout premier président de la jeune République togolaise indépendante, marquant ainsi l'aboutissement historique de plusieurs décennies de luttes politiques et de résistances populaires."}
  ],
  ...
  croquis: null,
  photo: {fichier: "h3_8_sylvanus_olympio.jpg", legende: "Sylvanus Olympio, premier président du Togo"}
},
...
h3_9: {
  ...
  resume: [
    {titre:"1. Le Togo, premier théâtre africain de la Première Guerre mondiale", texte:"Dès le mois d'août 1914, immédiatement après le déclenchement du conflit mondial en Europe, les forces militaires françaises venues du Dahomey voisin et les forces britanniques venues de la colonie de la Gold Coast envahissent conjointement et rapidement le territoire du Togoland allemand. Après plusieurs combats significatifs livrés notamment à Agbélouvé puis à Khra (également appelée Chra), les troupes coloniales allemandes, nettement en infériorité numérique et militaire face aux forces alliées coalisées, capitulent finalement dès le 26 août 1914 — constituant ainsi historiquement l'une des toutes premières victoires militaires alliées de l'ensemble de la Première Guerre mondiale."},
    {titre:"2. Le partage territorial du Togoland après la victoire alliée", texte:"À l'issue définitive du conflit mondial, l'ancien territoire colonial du Togoland allemand est officiellement partagé entre la France et la Grande-Bretagne victorieuses, sous mandat international de la Société des Nations nouvellement créée à partir de 1922 : la partie orientale du territoire devient ainsi le Togo placé sous administration française, tandis que la partie occidentale (le Togoland britannique) est directement rattachée administrativement à la colonie voisine de la Gold Coast."},
    {titre:"3. Des conséquences historiques durables pour le Togo", texte:"Ce partage territorial arbitraire sépare durablement des populations togolaises pourtant de même origine ethnique et culturelle commune, créant une fracture historique profonde dont les effets politiques et sociaux continuent de se faire sentir aujourd'hui encore, notamment lors de l'échec du référendum de réunification organisé en 1956, référendum qui n'aboutit finalement pas au résultat escompté par les nationalistes togolais de l'époque."}
  ],
...
h3_10: {
  ...
  resume: [
    {titre:"1. L'impact de la Seconde Guerre mondiale sur le continent africain", texte:"Bien que se déroulant principalement sur les théâtres d'opérations européen, asiatique et nord-africain, la Seconde Guerre mondiale (1939-1945) mobilise également, de façon significative, l'ensemble des colonies d'Afrique subsaharienne, y compris le territoire togolais, à travers l'enrôlement massif de nombreux tirailleurs africains ainsi que par une contribution économique importante et souvent contrainte à l'effort de guerre global des métropoles coloniales respectives."},
    {titre:"2. La création historique de l'Organisation des Nations unies", texte:"À l'issue définitive de ce second conflit mondial particulièrement meurtrier, l'Organisation des Nations unies est officiellement créée en 1945 lors de la conférence de San Francisco, avec pour mission fondamentale explicite le maintien durable de la paix internationale ainsi que la prévention active de tout nouveau conflit d'ampleur mondiale. Cette nouvelle organisation internationale remplace définitivement l'ancien système des mandats coloniaux de la défunte Société des Nations par celui, plus progressiste, de la tutelle internationale, dont bénéficiera directement le Togo dès l'année 1946."},
    {titre:"3. La culture de la paix comme héritage durable", texte:"La notion de culture de la paix désigne aujourd'hui l'ensemble cohérent des valeurs fondamentales, des attitudes personnelles et des comportements sociaux qui rejettent catégoriquement le recours à la violence tout en favorisant activement le dialogue constructif, la tolérance mutuelle et la coopération pacifique entre l'ensemble des peuples du monde — un objectif fondateur qui demeure aujourd'hui encore absolument central dans l'action quotidienne des Nations unies depuis leur création officielle en 1945."}
  ],
...
h3_11: {
  ...
  resume: [
    {titre:"1. Une indépendance nationale durement conquise", texte:"Le Togo accède définitivement à son indépendance nationale complète le 27 avril 1960, sous la présidence historique de Sylvanus Olympio, mettant ainsi un terme officiel et définitif à plusieurs décennies successives de domination coloniale, d'abord allemande puis française, marquées par de nombreuses résistances populaires et de longues luttes politiques pour la liberté nationale."},
    {titre:"2. Les défis majeurs de la construction nationale post-coloniale", texte:"Immédiatement après la proclamation de son indépendance, le jeune État togolais nouvellement souverain doit relever simultanément plusieurs défis considérables : construire méthodiquement une administration nationale véritablement autonome et efficace, développer progressivement une économie nationale moins dépendante de l'ancienne métropole coloniale, et surtout parvenir à forger une véritable unité nationale durable entre ses nombreux groupes ethniques constitutifs, tout en gérant simultanément l'héritage complexe et parfois douloureux de la partition coloniale historique avec le Ghana voisin."},
    {titre:"3. Une nation togolaise toujours en construction continue", texte:"Comme de très nombreux autres pays africains nouvellement indépendants à cette même époque historique, le Togo traverse dans les années qui suivent d'importantes turbulences politiques internes (dont l'assassinat tragique du président Sylvanus Olympio survenu dès 1963), mais poursuit néanmoins, avec constance et résilience, sa construction nationale progressive en tant que nation véritablement souveraine, à travers le développement continu de ses institutions politiques, l'affirmation de sa riche culture nationale partagée, et la poursuite patiente de son développement économique et social sur le long terme."}
  ],
